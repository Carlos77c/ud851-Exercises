...
public class MainActivity extends AppCompatActivity {
    ...
    private final static String QUERY_URL_KEY = "url_key";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private final static String SEARCH_RESULTS_KEY = "s_results_key";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String textViewUrl = mUrlDisplayTextView.getText().toString();
        outState.putString(QUERY_URL_KEY, textViewUrl);
        ...
        String textViewSearchResults = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RESULTS_KEY, textViewSearchResults);
    }
