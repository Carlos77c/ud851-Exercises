...
public class AddTaskActivity extends AppCompatActivity {
    ...
    public void onClickAddTask(View view) {
        ...
        Editable inputText = ((EditText)findViewById(R.id.editTextTaskDescription)).getText();
        if(TextUtils.isEmpty(inputText)){
           return;
        }
        // COMPLETED (7) Insert new task data via a ContentResolver
        ContentValues contentValues = new ContentValues();
        contentValues.put(TaskContract.TaskEntry.COLUMN_DESCRIPTION, inputText.toString());
